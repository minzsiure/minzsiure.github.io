...
2. <strong>Mechanistic</strong>: Analyzing networks with biologically plausible properties, such as theoretically underexplored heavy-tailed synaptic weight distributions <a href="#" style="pointer-events:none; cursor:default; text-decoration:none;">[<span style="font-weight: bold; color: inherit;">Yi Xie</span>, Stefan Mihalas, Łukasz Kuśmierz; In Review]</a>, <em>or</em> skip connections <a href="https://openreview.net/forum?id=EJmgk8vXMQ" target="_blank">[<span style="font-weight: bold; color: inherit;">Yi Xie</span>, Yichen Li, Akshay Ranganmani; NeurIPS AMHN 2023]</a>, to reveal the dynamics and constraints imposed by connectivity structure alone;
